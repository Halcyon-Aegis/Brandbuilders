<section class="px-4 py-16 sm:py-36 sm:px-6 lg:px-8">
    <div class="container mx-auto">
        <div class="flex flex-col items-center gap-8 md:flex-row">
            ...
            <!-- Content -->
            <div class="w-full md:w-2/3 sm:px-14">
                <h2 class="mb-8 text-3xl font-semibold text-gray-900 sm:text-5xl">
                ...
                <p class="mb-6 text-2xl text-gray-600">
                    ...
                    <a href="#" class="text-[#00AA00] hover:text-green-600">click here to fill a form</a>
                </p>
            </div>
        </div>
    </div>
