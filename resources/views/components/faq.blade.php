<section class="px-4 py-16 sm:px-6 lg:px-8">
    <div class="max-w-4xl mx-auto">
        <p class="mb-4 text-2xl tracking-wider text-center text-gray-500 uppercase">FREQUENTLY ASKED QUESTIONS</p>
        <h2 class="mb-12 text-3xl font-bold text-center text-gray-900 sm:mb-24 sm:text-5xl">Website Design Q&A</h2>
        ...
        <div class="space-y-4">
            <div x-data="{ open: false }" class="border-b border-gray-200">
                <button @click="open = !open" class="flex items-center justify-between w-full py-4 text-left">
                    <span class="text-2xl font-medium text-gray-900">Why should I hire you for Web Design and Online marketing</span>
                ...
                <div x-show="open" x-collapse>
                    <div class="pb-4 text-xl text-gray-600">
            ...
            <div x-data="{ open: false }" class="border-b border-gray-200">
                <button @click="open = !open" class="flex items-center justify-between w-full py-4 text-left">
                    <span class="text-2xl font-medium text-gray-900">How long would it take to build a website?</span>
                    <svg :class="{'rotate-180': open}" class="w-6 h-6 transition-transform duration-200 transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg>
                </button>
            ...
            <div x-data="{ open: false }" class="border-b border-gray-200">
                <button @click="open = !open" class="flex items-center justify-between w-full py-4 text-left">
                    <span class="text-2xl font-medium text-gray-900">Will I own the website?</span>
                    <svg :class="{'rotate-180': open}" class="w-6 h-6 transition-transform duration-200 transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg>
                </button>
            ...
            <div x-data="{ open: false }" class="border-b border-gray-200">
                <button @click="open = !open" class="flex items-center justify-between w-full py-4 text-left">
                    <span class="text-2xl font-medium text-gray-900">What's your payment plan?</span>
                    <svg :class="{'rotate-180': open}" class="w-6 h-6 transition-transform duration-200 transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg>
                </button>
            ...
            <div x-data="{ open: false }" class="border-b border-gray-200">
                <button @click="open = !open" class="flex items-center justify-between w-full py-4 text-left">
                    <span class="text-2xl font-medium text-gray-900">Do you offer support after launch of website projects?</span>
                    <svg :class="{'rotate-180': open}" class="w-6 h-6 transition-transform duration-200 transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                    </svg>
                </button>
