<footer class="bg-[#2B2D42] text-white pt-16 pb-8 px-4 sm:px-6 lg:px-8 relative">
    ...
    <a href="https://wa.me/your-number"
       class="fixed z-50 flex items-center justify-center text-white transition duration-300 bg-[#00AA00] rounded-full shadow-lg bottom-6 right-6 hover:bg-green-600 w-14 h-14">
