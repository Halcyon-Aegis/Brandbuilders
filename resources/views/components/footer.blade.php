...
<footer class="mt-5 bg-[#2B2D42] dark:bg-gray-900 md:p-10 ">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between text-white">
          ...
          <div class="grid md:grid-cols-3 grid-cols-1 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                  <h2 class="mb-6 md:text-start text-center text-sm font-semibold text-white uppercase dark:text-white">OUR SERVICES</h2>
