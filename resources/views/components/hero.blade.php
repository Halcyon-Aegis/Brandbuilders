...
<section class="bg-white">
    <div class="grid max-w-screen-xl px-6 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="mr-auto lg:col-span-7">
            <p class="text-center md:text-start max-w-2xl mb-3 font-light text-gray-500 lg:mb-4 md:text-lg lg:text-xl">Welcome to Halcyon Aegis Internet</p>

            <h1 id="dropping-text" class="text-center md:text-start max-w-2xl mb-4 text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-extrabold tracking-tight leading-tight">
            Architecting Tomorrow's Digital Landscape <span id="typing-text" class="cursor"></span>
              </h1>
                          <p class="text-center md:text-start max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl">
