  ...
  <div class="py-4 overflow-y-auto">
      <ul class="space-y-8 font-medium">
        <li>
         ...
         <li>
            <a href="/about" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-500 dark:hover:bg-gray-700 group">
         ...
         <li>
            <button type="button" class="text-white flex items-center w-full p-2 text-base transition duration-75 rounded-lg group hover:bg-gray-500 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                  <svg class="flex-shrink-0 w-5 h-5  transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 18 21">
            ...
            <ul id="dropdown-example" class="hidden justify-evenly py-2 space-y-2">
                  <li>
                     <a href="#" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-gray-500 dark:text-white dark:hover:bg-gray-700">web & Mobile</a>
                  </li>
                  <li>
                     <a href="#" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-gray-500 dark:text-white dark:hover:bg-gray-700">UI/UX Design</a>
                  </li>
                  <li>
                     <a href="#" class="flex items-center w-full p-2 text-white transition duration-75 rounded-lg pl-11 group hover:bg-gray-500 dark:text-white dark:hover:bg-gray-700">Graphic Design</a>
                  </li>
            </ul>
         </li>
         <li>
            <a href="/portfolio" class="flex items-center p-2 rounded-lg dark:text-white text-white hover:bg-gray-500 dark:hover:bg-gray-700 group">
         ...
         <li>
            <a href="blog" class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-500 dark:hover:bg-gray-700 group">
    ...
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
        ...
        <li>
          <a href="/portfolio" class="block py-2 px-3  rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent">Portfolio</a>
        </li>
        <li>
